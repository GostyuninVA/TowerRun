...
public class Tower : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        int humanInTower = Random.Range(_humanIntowerRange.x, _humanIntowerRange.y);

        SpawnHumans(humanInTower);
    }
    ...
    {
        Vector3 vectorCheckingY = new Vector3(0, distanceChecker.position.y, 0);
        Vector3 humanFixationPointY = new Vector3(0, humanFixationPoint.position.y, 0);

        return Vector3.Distance(vectorCheckingY, humanFixationPointY);
    }
}
